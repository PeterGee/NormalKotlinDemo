...
class DesignModeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_horizontal.apply {
            layoutManager =
                LinearLayoutManager(this@DesignModeActivity, LinearLayoutManager.HORIZONTAL, false)
            addItemDecoration(DividerItemDecoration(this@DesignModeActivity,DividerItemDecoration.VERTICAL))
